...
ところがIFには様々な問題点があり、これらの問題を解決するためにEigen Factor（EF）などの指標もありますが、日本ではあまり浸透していない印象です。最近ではGoogleが[h5 index](https://scholar.google.com/citations?view_op=top_venues&hl=en&vq=med)というcitation scoreを公開しており、こちらを参考にするのもいいでしょう。
